  ...
  return (
    <>
              ...
              <div className="row ">
                <div className="col-lg-5 col-md-12 col-12">
                  <div className="banner-info">
                    ...
                    <p>
                      Connect directly with reliable buyers, negotiate
                ...
                <div className="col-lg-7 col-md-12 col-12">
                  <div className="imgBox1">
                    <img
                      ...
                      className="img-fluid"
                      alt=""
                      style={{ height: '290px', borderRadius: '20%' }}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-lg-5 col-md-12 col-12">
                  <div className="banner-info">
                    ...
                    <p>
                      Find trusted farmers, negotiate prices, and secure your
                      supply chain with ease.
                    </p>
                    <p style={{ fontSize: 'smaller' }}>
                      <a href="landingPage.html" className="btn mt-3">
                ...
                <div className="col-lg-7 col-md-12 col-12">
                  <div className="imgBox">
                    <img
                      ...
                      className="img-fluid"
                      alt=""
                      style={{ borderRadius: '30%', height: '290px' }}
                    />
                  </div>
                </div>
              </div>
      ...
      <section className="central-section">
        ...
        <div className="features">
          <div className="feature">
            ...
            <p>
              Connect with verified buyers and secure a steady market for your
              produce.
            </p>
          </div>
          <div className="feature">
          ...
          <div className="feature">
            ...
            <p>
              From initial contact to final delivery, we ensure smooth
              transactions.
            </p>
          </div>
        </div>
      ...
      <section className="how-it-works">
        ...
        <ol>
          <li>
            <strong>Sign Up & Create Your Profile:</strong> Farmers and buyers
            can easily sign up and create a profile tailored to their needs.
          </li>
          <li>
            <strong>Connect & Negotiate:</strong> Use our platform to discover
            potential partners and establish secure contracts.
          </li>
          <li>
            <strong>Deliver & Get Paid:</strong> Farmers deliver the produce as
            per the contract and receive timely payments.
          </li>
        </ol>
      </section>
